...
pub fn estimate_homography(
    ...
    let scoring = RansacInlierCountScoring::new(threshold, |data, model: &Homography, idx| {
...
pub fn estimate_essential_matrix(
    ...
    let sampler = UniformRandomSampler::new();
    let scoring = RansacInlierCountScoring::new(threshold, |data, model: &EssentialMatrix, idx| {
        // Compute Sampson error
        let p1 = Vector2::new(data[(idx, 0)], data[(idx, 1)]);
        let p2 = Vector2::new(data[(idx, 2)], data[(idx, 3)]);
...
pub fn estimate_absolute_pose(
    ...
    let sampler = UniformRandomSampler::new();
    let scoring = RansacInlierCountScoring::new(threshold, |data, model: &AbsolutePose, idx| {
